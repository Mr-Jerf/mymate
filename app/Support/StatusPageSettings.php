...
class StatusPageSettings
{
    public const DEFAULTS = [
        ...
        'public_enabled' => true,
        'monitoring_grace_minutes' => 30,
        'logo_url' => '/logo.svg',
        'favicon_url' => '/favicon.svg',
        'color_operational' => '#34d399',
        'color_degraded' => '#fb923c',
        'color_monitoring' => '#fbbf24',
        'color_outage' => '#f87171',
    ...
    public function publicView(): array
    {
        return [
            ...
            'monitoring_grace_minutes' => (int) $this->get('monitoring_grace_minutes'),
            ...
            'color_monitoring' => (string) $this->get('color_monitoring'),
