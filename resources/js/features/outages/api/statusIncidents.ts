...
export type StatusIncident = { id: number; state: string; severity: 'outage' | 'degraded'; status: 'investigating' | 'monitoring' | 'resolved'; summary: string | null; started_at: string; resolved_at: string | null };
